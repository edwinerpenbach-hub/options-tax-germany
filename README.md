...
| Platform | Download |
|---|---|
| Windows | [**options_tracker_windows.exe**](https://github.com/edwinerpenbach-hub/options-tax-germany/releases/latest/download/options_tracker_windows.exe) |
| macOS | [**options_tracker_macos**](https://github.com/edwinerpenbach-hub/options-tax-germany/releases/latest/download/options_tracker_macos) |
| Linux | [**options_tracker_linux**](https://github.com/edwinerpenbach-hub/options-tax-germany/releases/latest/download/options_tracker_linux) |
